...
public class HoodProductProductionTimeAdminViewComponent : ViewComponent
{
    private readonly IProductProductionTimeService _productionTimeService;

    public HoodProductProductionTimeAdminViewComponent(IProductProductionTimeService productionTimeService)
    {
    ...
    public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData = null)
    {
        ...
        return View("~/Plugins/Shipping.FixedByWeightByTotal/Views/Components/HoodProductProductionTimeAdmin/Default.cshtml", model);
    }
