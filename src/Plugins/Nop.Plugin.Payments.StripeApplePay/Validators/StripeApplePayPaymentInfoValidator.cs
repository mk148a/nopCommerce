...
{
    public partial class StripeApplePayPaymentInfoValidator : BaseNopValidator<PaymentInfoModel>
    {
   
        public StripeApplePayPaymentInfoValidator(ILocalizationService localizationService)
        {
