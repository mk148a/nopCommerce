...
public class BrevoPlugin : BasePlugin, IMiscPlugin, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Misc.Brevo.LocalStoreOwnerSmtp.Description"] = "Order and other store-owner notifications can use local hMailServer. Customer emails remain on Brevo. The configured 127.0.0.1:25 relay is trusted and does not use SMTP authentication.",
