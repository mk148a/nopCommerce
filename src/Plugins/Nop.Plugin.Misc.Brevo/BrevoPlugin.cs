...
public class BrevoPlugin : BasePlugin, IMiscPlugin, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpHost.Hint"] = "Use 127.0.0.1 for the local hMailServer instance.",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpPassword"] = "Local SMTP password",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpPassword.Hint"] = "Leave blank to keep the previously saved password.",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpPort"] = "Local SMTP port",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpPort.Hint"] = "Use 25 for the local hMailServer SMTP listener.",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpUseSsl"] = "Use SSL for local SMTP",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpUseSsl.Hint"] = "Leave unchecked unless hMailServer is configured for TLS on this port.",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpUsername"] = "Local SMTP username",
            ["Plugins.Misc.Brevo.Fields.LocalStoreOwnerSmtpUsername.Hint"] = "Required only when hMailServer requires SMTP authentication.",
            ...
            ["Plugins.Misc.Brevo.Fields.UseLocalStoreOwnerSmtp.Hint"] = "Routes only mail addressed to the configured store owner through the local SMTP server; customer mail remains on Brevo.",
