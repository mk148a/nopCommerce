...
namespace Nop.Plugin.Widgets.CustomProductReviews.Services
{
    ...
    /// </summary>
    public partial interface ICustomProductReviewsVideoService
    {
        /// <summary>
        ...
        /// </returns>
        Task<byte[]> LoadVideoBinaryAsync(CustomProductReviewsVideo video);
        ...
        /// The task result contains the video URL
        /// </returns>
        Task<(string Url, CustomProductReviewsVideo Video)> GetVideoUrlAsync(CustomProductReviewsVideo video,
            int targetSize = 0,
            bool showDefaultVideo = true,
            string storeLocation = null,
            PictureType defaultVideoType = PictureType.Entity);
        ...
        /// </returns>
        Task<string> GetThumbLocalPathAsync(CustomProductReviewsVideo video, int targetSize = 0, bool showDefaultVideo = true);
        ...
        /// </returns>
        Task<CustomProductReviewsVideo> GetVideoByIdAsync(int videoId);
        ...
        Task DeleteVideoAsync(CustomProductReviewsVideo video);
        ...
        /// </returns>
        Task<IPagedList<CustomProductReviewsVideo>> GetVideosAsync(string virtualPath = "", int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        /// The task result contains the video
        /// </returns>
        Task<CustomProductReviewsVideo> InsertVideoDataAsync(byte[] videoBinary, string mimeType, string seoFilename,
        ...
        /// The task result contains the video
        /// </returns>
        Task<CustomProductReviewsVideo> InsertVideoAsync(byte[] formFile, string defaultFileName , string contentType, string virtualPath = "");
        ...
        /// The task result contains the video
        /// </returns>
        Task<CustomProductReviewsVideo> UpdateVideoAsync(int videoId, byte[] videoBinary, string mimeType,
        ...
        /// The task result contains the video
        /// </returns>
        Task<CustomProductReviewsVideo> UpdateVideoAsync(CustomProductReviewsVideo video);
        ...
        /// The task result contains the video
        /// </returns>
        Task<CustomProductReviewsVideo> SetSeoFilenameAsync(int videoId, string seoFilename);
